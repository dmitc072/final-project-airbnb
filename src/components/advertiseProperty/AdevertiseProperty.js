...
export const AdvertiseProperty = () => {
  ...
  const priceCalculator = async () => {
    try {
      ...
      const priceCalculatorResponse = await axios.post(
        'https://airbnb-ml.onrender.com/predict',
        data,
      );
      ...
      if (zipValue.length === 5) {
        ...
        try {
          ...
          const fetchData = await axios.get(
            `https://geocode.maps.co/search?q=${addressValue},${cityValue},${stateValue}&api_key=${token}`,
          );
  ...
  }, [zipValue, addressValue, cityValue, stateValue]);
      ...
      >
        ...
        <Box sx={column}>
          ...
          <Box className={styles.container}>
            <Typography gutterBottom>Property Name</Typography>
            <TextField
          ...
          <Box className={styles.container}>
            ...
            <div className={styles.price}>
              <TextField
                ...
                InputProps={{
                  startAdornment: (
                    <InputAdornment className={styles.sign} position="start">
                      $
                    </InputAdornment>
                  ),
                }}
                ...
                fullWidth
              />
              <Button sx={{ width: '100px' }} onClick={() => priceCalculator()}>
                Price Estimator
              </Button>
            </div>
          </Box>
