    ...
    <>
      ...
      <div className={styles.container}>
        <Typography sx={{ fontWeight: 'bold' }} variant="h5">
          Approved Property Request to Rent
        </Typography>
        <br />
                  ...
                  <div className={styles.row}>
                    ...
                    <div className={styles.button}>
                      ...
                      <Button
                        ...
                        disabled={compareDateStringToToday(approved.toDate) || approved.reviewSent}
                        onClick={() => approveRequest(approvedProperty, approved.id)}
                      >
                        Leave Review
                      </Button>
                    </div>
